...
class CollectRouteListItem extends StatelessWidget {
  ...
  Widget _buildToggleNotificationButton(CollectRoute collectRoute, CollectDayNotificationController controller){
      if(controller.hasCachedIds()){
        var initialState = controller.cachedActiveCollectRouteNotificationsIds.contains(collectRoute.id);
...
class ToggleNotificationButtonCashed extends StatelessWidget {
  ...
  const ToggleNotificationButtonCashed(this._collectRoute, this.initialState, {Key key,}) : super(key: key);
  @override
  Widget build(BuildContext context) {
...
class ToggleNotificationButtonNoCache extends StatelessWidget {
  ...
  const ToggleNotificationButtonNoCache(this._collectRoute, this._controller, {Key key,}) : super(key: key);
  @override
  Widget build(BuildContext context) {
