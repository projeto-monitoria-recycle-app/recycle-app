...
class NotificationCounter extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    CollectDayNotificationController controller = Provider.of<CollectDayNotificationController>(context);

       return FutureBuilder<Set<int>>(future: controller.getActiveCollectRouteNotificationsIds(),
  ...
  Widget _buildCounter(String notificationQuantity){
    return Row(
      ...
      children: [Text(notificationQuantity.toString()), Icon(Icons.notifications_none, color: Colors.black54)],
    );
  }
